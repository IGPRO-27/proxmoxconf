...
Un simple ~git pull~ reconstruira l'historique odoo du début ce qui aura pour effet de tripler le volume de l'installation et de rogner sur le crédit de flux.
